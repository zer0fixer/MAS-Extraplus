...
label extra_talk_pop:
    ...
    if mas_isMoniLove():
        m "Or maybe..."
        $ mas_display_notif(m_name, ["The sound of my notifaction? Ahaha~!"], group=None, skip_checks=True)
...
label generic_date_dev:
    show monika idle at t11
    call screen dialog(_("It is currently in development and will be available in upcoming betas!"), ok_action=Return())
