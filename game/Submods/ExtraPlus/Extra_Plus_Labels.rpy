...
label cafe_hide_acs:
    python:
        ...
        if food_worn and cup_worn:
            renpy.say(m, _("I have to put this plate and cup away. I won't be long."))
        elif food_worn:
            renpy.say(m, _("I have to put this plate away. I'll be right back."))
        elif cup_worn:
            renpy.say(m, _("I'll just put this cup away, give me a moment."))
...
label restaurant_hide_acs:
    python:
        ...
        if monika_chr.is_wearing_acs(extraplus_acs_candles):
            renpy.say(m, _("I have to put these candles away. We can never be too careful with fire!"))

        # Check and remove flowers if it's day
        if monika_chr.is_wearing_acs(extraplus_acs_flowers):
            renpy.say(m, _("I'll put these flowers away, I won't be long."))
        ...
        if any(monika_chr.is_wearing_acs(acs) for acs in food_acs_to_check):
            renpy.say(m, _("I must put this plate away, it won't be long now."))
...
label plus_make_file:
    ...
    python:
        ...
        if not makegift:
            ...
            renpy.notify(renpy.substitute(_("Done: /characters/{}.gift")).format(makegift))
            renpy.jump("plus_make_gift")
